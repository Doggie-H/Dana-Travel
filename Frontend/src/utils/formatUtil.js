...
export function formatDate(date) {
  // Nếu đã là chuỗi DD/MM/YYYY, trả về nguyên vẹn
...
/**
 * Chuyển đổi giờ thập phân sang HH:mm.
 * Ví dụ: 9.5 -> "09:30"
 * 
 * @param {number} decimalTime 
 * @returns {string}
 */
export function formatDecimalTime(decimalTime) {
  if (decimalTime === undefined || decimalTime === null) return "00:00";

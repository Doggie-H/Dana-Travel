...
**Hệ thống Lập Kế Hoạch Du Lịch Thông Minh cho Đà Nẵng**

[![Node.js](https://img.shields.io/badge/Node.js-18+-339933?style=flat&logo=node.js&logoColor=white)](https://nodejs.org/)
[![React](https://img.shields.io/badge/React-18-61DAFB?style=flat&logo=react&logoColor=black)](https://reactjs.org/)
[![TypeScript](https://img.shields.io/badge/Prisma-ORM-2D3748?style=flat&logo=prisma&logoColor=white)](https://www.prisma.io/)
[![License](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

[Tính Năng](#-tính-năng-chính) • [Demo](#-demo) • [Cài Đặt](#-cài-đặt) • [Tài Liệu](#-tài-liệu) • [Đóng Góp](docs/CONTRIBUTING.md)
...
**Dana Travel** là một nền tảng web thông minh giúp du khách tự động lập kế hoạch du lịch tại Đà Nẵng dựa trên ngân sách, thời gian và sở thích cá nhân. Hệ thống kết hợp thuật toán tối ưu hóa lộ trình với AI Chatbot hỗ trợ 24/7 để mang đến trải nghiệm du lịch liền mạch và được cá nhân hóa.

### 🎯 Vấn Đề Giải Quyết

- ❌ **Quá tải thông tin**: Du khách phải mất 2-3 giờ để nghiên cứu và lập kế hoạch
- ❌ **Khó tối ưu ngân sách**: Không biết phân bổ chi phí hợp lý giữa ăn/ở/chơi
- ❌ **Lộ trình kém hiệu quả**: Di chuyển không tối ưu, tốn thời gian và tiền bạc
- ❌ **Thiếu hỗ trợ real-time**: Không có ai tư vấn khi gặp sự cố (trời mưa, đổi kế hoạch...)

### ✅ Giải Pháp

- ✨ **Tự động tạo lịch trình** trong < 3 giây với thuật toán Greedy + Local Optimization
- 💰 **Phân bổ ngân sách thông minh** dựa trên số người, số ngày và loại chỗ ở
- 🗺️ **Tối ưu hóa lộ trình** giảm thiểu quãng đường di chuyển (thuật toán TSP)
- 🤖 **AI Chatbot** tích hợp RAG (Retrieval-Augmented Generation) hỗ trợ 24/7

---

## 🚀 Tính Năng Chính

### 1️⃣ Lập Lịch Trình Tự Động (Trip Planner)

- 📝 **Multi-step Form**: Wizard 5 bước thu thập thông tin người dùng
- 🎯 **Smart Filtering**: Lọc địa điểm theo sở thích (beach, food, culture, nightlife...)
- 💵 **Budget Breakdown**: Tự động phân bổ chi phí cho accommodation, food, transport, activities
- ⏰ **Day-by-Day Schedule**: Lên lịch chi tiết từng ngày với thời gian cụ thể (08:00 - Ăn sáng, 09:30 - Bãi biển...)
- 🗺️ **Interactive Map**: Hiển thị lộ trình trên bản đồ OpenStreetMap với markers và routes

### 2️⃣ AI Chatbot Thông Minh

- 🧠 **RAG Architecture**: Kết hợp Knowledge Base (địa điểm, menu, giá vé) với Google Gemini AI
- 💬 **Natural Language**: Hiểu tiếng Việt tự nhiên ("quán ăn ngon gần đây", "trời mưa đi đâu")
- 🔄 **Itinerary Modification**: Thay đổi lịch trình real-time qua chat ("đổi bà nà thành asia park")
- ⚡ **Hybrid Intent Detection**: Rule-based + AI fallback cho tốc độ và độ chính xác

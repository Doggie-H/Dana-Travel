...
export const knowledgeData = [
  ...
  {
    "question": "Bánh xèo Bà Dưỡng ở đâu?",
    "answer": "Quán Bánh xèo Bà Dưỡng nằm sâu trong hẻm nhưng cực nổi tiếng:\n\n- **Địa chỉ**: K280/23 Hoàng Diệu\n- **Đặc điểm**: Nước chấm gan heo thần thánh, vỏ bánh giòn tan\n- **Giá**: Khoảng 60.000-80.000đ/người no nê\n- **Lưu ý**: Đường vào hẻm hơi nhỏ, đi xe máy tiện hơn taxi. Quán rất đông tầm 19:00.",
    "keywords": "food"
  },
  {
    "question": "Chè Liên có gì ngon?",
    "answer": "Chè Liên là thương hiệu chè nổi tiếng nhất Đà Nẵng:\n\n- **Món Best-seller**: Chè Thái sầu riêng (đậm vị sầu riêng, nước cốt dừa béo)\n- **Giá**: 30.000-35.000đ/ly\n- **Cơ sở**: Có nhiều chi nhánh, nhưng cơ sở chính ở 189 Hoàng Diệu hoặc 175 Hải Phòng là đông nhất.\n- **Tip**: Có thể mua đóng thùng mang về làm quà (để được 1 ngày).",
    "keywords": "food"
  },
  {
    "question": "Cầu sông Hàn quay lúc mấy giờ?",
    "answer": "Giờ quay của Cầu Sông Hàn:\n\n- **Thứ 7 & Chủ Nhật**: Quay từ 23:00 đến 24:00\n- **Mục đích**: Để phục vụ du lịch là chính (trước kia là để tàu đi qua)\n- **Vị trí xem**: Đứng ngay trên bờ sông hoặc quán cafe gần đó.\n\nĐây là cây cầu quay duy nhất ở Việt Nam đó!",
    "keywords": "travel"
  },
  {
    "question": "Mua quà gì mang về?",
    "answer": "Đặc sản Đà Nẵng làm quà phổ biến:\n\n1. **Chả bò Đà Nẵng**: Thơm cay tiêu, ngọt thịt (280-350k/kg)\n2. **Tré Bà Đệ**: Món nhậu trứ danh, gói lá chuối\n3. **Mực rim me**: Hũ nhỏ tiện mang (50-80k/hũ)\n4. **Bánh khô mè Cẩm Lệ**: Bánh cổ truyền\n5. **Nước mắm Nam Ô**: Đậm đà vị biển\n\nMua ở Chợ Hàn hoặc siêu thị đặc sản Thiên Phú đều uy tín.",
    "keywords": "shopping"
  },
  {
    "question": "Đi Cù Lao Chàm như thế nào?",
    "answer": "Cù Lao Chàm cách cảng Cửa Đại (Hội An) 20 phút đi cano:\n\n- **Tour trọn gói**: 550.000-650.000đ/khách (Bao đưa đón từ ĐN, cano, ăn trưa, lặn ngắm san hô)\n- **Tự túc**: Phải tự đến cảng Cửa Đại, mua vé cano (350k/khứ hồi) + phí tham quan (70k)\n- **Lưu ý đặc biệt**: Cù Lao Chàm KHÔNG sử dụng túi nilon. Bạn nhớ mang túi vải nhé!",
    "keywords": "travel"
  },
  {
    "question": "Vé Asia Park bao nhiêu?",
    "answer": "Giá vé Công viên Châu Á (Asia Park) 2024:\n\n- **Vào cổng**: Miễn phí (tham quan, chụp ảnh)\n- **Vé All-in-one** (Chơi tất cả trò chơi):\n- Người lớn: 200.000-250.000đ\n- Trẻ em: 150.000đ\n- **Sun Wheel**: Vòng quay mặt trời ngắm toàn cảnh (thường bán vé lẻ 100k)\n\nCông viên mở từ 15:00 - 22:00. Đi buổi tối sẽ đẹp hơn nhiều!",
    "keywords": "entertainment"
  },
  {
    "question": "Cafe nào yên tĩnh đọc sách?",
    "answer": "Những quán cafe 'trốn' ồn ào:\n\n1. **Nhã Nam Books N' Coffee**: Không gian đầy sách, yên tĩnh tuyệt đối (Pasteur)\n2. **Hùng Coffee**: Phong cách xưa cũ, nhạc Trịnh (Thái Phiên)\n3. **Wonderlust**: Tầng 2 rộng, sáng sủa, nhiều người làm việc\n4. **The Local Beans**: Chuyên coworking, wifi mạnh\n\nBạn thích không gian kiểu thư viện hay sân vườn?",
    "keywords": "practical"
  },
  {
    "question": "Bánh tráng kẹp ăn ở đâu?",
    "answer": "Món ăn vặt huyền thoại của giới trẻ Đà Nẵng:\n\n- **Bánh tráng kẹp Dì Hoa** (K168/7 Trưng Nữ Vương): Nổi tiếng nhất, pate ngon\n- **Bánh tráng kẹp Dì Hoàng** (K142/46 Điện Biên Phủ)\n- **Giá**: 10.000-15.000đ/đĩa\n- **Món phải gọi**: Bánh tráng kẹp trứng ướt, kẹp pate, bánh tráng rải.",
    "keywords": "food"
  },
  {
    "question": "Kinh nghiệm đi VinWonders Nam Hội An?",
    "answer": "VinWonders Nam Hội An cách Đà Nẵng ~40km (xa hơn Hội An):\n\n- **Di chuyển**: Có xe bus miễn phí của Vinpearl đón tại Đà Nẵng (cần check lịch trước)\n- **Điểm nhấn**: River Safari (đi thuyền xem thú), Đảo Văn Hóa Dân Gian, Công viên nước\n- **Thời gian**: Nên đi từ sáng sớm, chơi cả ngày mới hết\n- **Ăn uống**: Không được mang đồ ăn vào, trong đó có nhà hàng (giá hơi cao).\n\nThích hợp cho gia đình có trẻ nhỏ!",
    "keywords": "entertainment"
  },
  {
    "question": "Tắm bùn Galina hay Núi Thần Tài?",
    "answer": "So sánh 2 điểm tắm bùn hot nhất:\n\n1. **Công viên Suối khoáng nóng Núi Thần Tài**:\n- Cách trung tâm 30km (đi xe 45p)\n- Quy mô lớn, công viên nước, tắm Onsen, luộc trứng\n- Thích hợp đi cả ngày, dã ngoại\n\n2. **Galina Mud Bath & Spa**:\n- Nằm ngay gần biển Mỹ Khê (trong phố)\n- Tiện lợi, không cần đi xa\n- Thích hợp thư giãn 2-3 tiếng\n\nNếu có thời gian thì đi Thần Tài vui hơn, còn bận thì ghé Galina nhé!",
    "keywords": "entertainment"
  }
];
